...
**Версия:** 2.16
**Дата:** 27 июля 2026
**Implementation Spec:** `Planner_MVP_MicroModel_Implementation_Spec_RU_v1.18.md`.
...
`I2−I0` — diagnostic, не veto и не sample-size component. Confirmatory TOST в v1.18 запрещён.
