...
**Stage 1:** `Planner_LLM_Stage1_Operator_Runbook_v2.19_RU.md`.
...
Runtime version: `work-planner/1.19`.
...
- любое изменение Scientific-lock path блокирует run и требует v1.19/new run;
...
## Нормативный inventory и training evidence v1.19
