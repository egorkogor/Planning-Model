...
def validate_evaluation(root: Path) -> dict:
    ...
    for persisted in rows:
        ...
        actual_evidence_hash = toy_hash("quality_evidence", {name: _file_hash(evidence_root / name) for name in sorted(actual)})
