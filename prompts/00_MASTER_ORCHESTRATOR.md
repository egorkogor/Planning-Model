# MASTER ORCHESTRATOR — Work Planner / BlocksWorld v1.14/v2.14
...
9. `docs/Planner_MVP_MicroModel_Implementation_Spec_RU_v1.14.md`;
10. `docs/Planner_LLM_Stage1_Operator_Runbook_v2.14_RU.md`;
