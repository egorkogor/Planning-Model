...
- `docs/Planner_MVP_MicroModel_Implementation_Spec_RU_v1.17.md`
- `docs/Planner_LLM_Stage1_Operator_Runbook_v2.17_RU.md`
...
- `P00_pre_02` — scope references work-planner/1.17 and runbook 2.17; verifier: `python validation/phase_check_runner.py --phase P00 --check P00_pre_02 --report reports/phase-P00.json`
