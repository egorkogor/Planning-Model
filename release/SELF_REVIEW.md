# Release self-review v1.20 / v2.20

## Scope

Проверены документы, 78 JSON Schema, 48 machine-readable YAML contracts, validators, state machine, generated phase prompts, lock policies и packaging. Полный regression suite: 219 tests PASS. Реальное обучение, Qwen inference, pilot и confirmatory run не выполнялись.
...
## Минимальные launch-инварианты v1.20
...
## Architecture freeze fixes v1.20
...
## Architecture evidence fixes v1.20
