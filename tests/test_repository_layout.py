...
def test_current_markdown_specs_and_contracts_exist() -> None:
    assert (ROOT / "docs/Planner_MVP_MicroModel_Implementation_Spec_RU_v1.17.md").is_file()
    assert (ROOT / "docs/Planner_LLM_Stage1_Operator_Runbook_v2.17_RU.md").is_file()
