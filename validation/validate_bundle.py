...
def main() -> None:
    ...
    for path in sorted(SCHEMA_DIR.glob("*.json")):
        ...
        assert obj["$id"].startswith("https://ml-brain.local/schemas/work-planner/v1.15/")
        schemas.append(path)
    ...
    required = [
        ROOT / "docs/Planner_MVP_MicroModel_Implementation_Spec_RU_v1.15.md",
        ROOT / "docs/Planner_LLM_Stage1_Operator_Runbook_v2.15_RU.md",
